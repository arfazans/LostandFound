    ...
    <div className="max-w-4xl mx-auto space-y-10">
      <div className="text-center space-y-4">
        <h1 className="text-4xl sm:text-5xl font-black text-gray-900 dark:text-white leading-tight">
          Report <span className="text-emerald-500">Found Item</span>
        </h1>
        <p className="text-gray-500 dark:text-neutral-400 max-w-xl mx-auto font-medium">
          Found something that doesn't belong to you? Help it find its way home.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="md:col-span-2 flex items-center gap-4">
            <div className="w-10 h-10 bg-emerald-500 rounded-full flex items-center justify-center text-white font-black">1</div>
          ...
          <div className="md:col-span-2">
            <FormInput
              ...
              value={formData.name}
              onChange={handleInputChange}
              placeholder="What did you find? (e.g. Silver Keychain)"
              required
            />
          </div>
          ...
          <div className="md:col-span-2">
            <FormTextArea
              ...
              onChange={handleInputChange}
              placeholder="Describe where you found it, specific marks, etc."
              required
            />
          </div>
          ...
          <div className="md:col-span-2">
            <FormTextArea
              ...
              onChange={handleInputChange}
              placeholder="What should the owner do to claim it?"
            />
          </div>
        </div>
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-gray-100 dark:border-neutral-800">
          <div className="text-center sm:text-left">
            <p className="text-lg font-bold text-gray-800 dark:text-white">Ready to help?</p>
            <p className="text-sm text-gray-500 dark:text-neutral-400">By submitting, you agree to our community guidelines.</p>
          </div>
          <button
            type="submit"
            disabled={isSubmitting}
            className="w-full sm:w-auto px-12 py-4 bg-emerald-600 text-white rounded-2xl font-black text-xl shadow-2xl hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
          >
            {isSubmitting ? 'Reporting...' : 'Found It!'}
          </button>
        </div>
      </form>
    </div>
