    ...
    return (
        ...
        <div className='dark:bg-neutral-800 min-h-dvh max-h-max  h-screen  overflow-auto box-border'>
            ...
            <div className='flex w-full justify-around p-2 items-center'>
                <button onClick={handleGeneralButtonClick} className={`transition-all rounded-md shadow-2xs bg-gradient-to-r from-dark:bg-neutral-800 to-dark:bg-neutral-600 shadow-blue-200 hover:text-lg hover:text-orange-600 cursor-pointer w-1/2 p-1.5 border border-white ${notificationType === "General" ? "text-red-500" : "text-white"
                    }`} >General Messages</button>


                <button onClick={handleResolutionButtonClick} className={`transition-all rounded-md shadow-2xs bg-gradient-to-r from-dark:bg-neutral-800 to-dark:bg-neutral-600 shadow-blue-200 hover:text-lg hover:text-orange-600 cursor-pointer w-1/2 p-1.5 border border-white ${notificationType === "Resolution" ? "text-red-500" : "text-white"
